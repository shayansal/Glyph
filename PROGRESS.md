...
- Replace notification contracts with live OS watcher streams, execute deeper per-glyph GPU shader/buffer paths in the hardware renderer, add generated native mobile projects, authenticated SSR capability sessions, and a polished visual devtools UI backed by the new Devtools Studio frame model.
