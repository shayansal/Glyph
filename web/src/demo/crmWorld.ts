...
export const crmWorld: GlyphWorld = {
  ...
  glyphs: {
    ...
    deal_northstar: { id: "deal_northstar", kind: "card", label: "Northstar Health", priority: "high", capability_bindings: [{ capability_id: "deal.update_stage" }] },
    deal_aster: { id: "deal_aster", kind: "card", label: "Aster Bank", priority: "normal", capability_bindings: [{ capability_id: "deal.update_stage" }] },
    deal_orbit: { id: "deal_orbit", kind: "card", label: "Orbit Supply", priority: "normal", capability_bindings: [{ capability_id: "deal.update_stage" }] },
