...
export class WasmGlyphspaceEngine {
    free(): void;
    [Symbol.dispose](): void;
    apply_patch(patch_json: string): string;
...
export interface InitOutput {
    ...
    readonly __wbg_wasmglyphspaceengine_free: (a: number, b: number) => void;
    readonly wasmglyphspaceengine_apply_patch: (a: number, b: number, c: number) => [number, number, number, number];
