...
export const __wbg_wasmglyphspaceengine_free: (a: number, b: number) => void;
export const wasmglyphspaceengine_apply_patch: (a: number, b: number, c: number) => [number, number, number, number];
